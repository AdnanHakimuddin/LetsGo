...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IOrderModelFactory
    {
        ...
        RentalBookingSearchModel PrepareRentalBookingSearchModelAsync(RentalBookingSearchModel searchModel);
        Task<RentaBookingListModel> PrepareRentaBookingListModelAsync(RentalBookingSearchModel searchModel);
        Task<RentalBookingModel> PrepareRentaBookingModelAsync(RentalBookingModel model, RentalBooking rentalBooking);

        Task<RentaBookingListModel> PrepareAdvanceBookingListModelAsync(RentalBookingSearchModel searchModel);
        Task<RentalBookingModel> PrepareAdvanceBookingModelAsync(RentalBookingModel model, RentalBooking rentalBooking);
    }
}