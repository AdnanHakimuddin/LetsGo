...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        private readonly IRepository<RentalBooking> _rentalBookingRepository;
        ...
        public OrderService(IHtmlFormatter htmlFormatter,
            ...
            IRepository<RentalBooking> rentalBookingRepository,
        ...
        public virtual async Task<RentalBooking> GetRentalBookingByIdAsync(int rentalBookingId)
        {
            return await _rentalBookingRepository.GetByIdAsync(rentalBookingId);
        }
        public virtual async Task<IPagedList<RentalBooking>> GetAllRentalBookingAsync(string name = null, int typeId = (int)BookingEnum.RentalBooking, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            var query = from r in _rentalBookingRepository.Table
                        where !r.Deleted
                        select r;
            ...
            query = query.Where(x => x.BookingTypeId == typeId);

            return await query.ToPagedListAsync(pageIndex, pageSize);
        }
        public virtual async Task DeleteRentalBookingAsync(RentalBooking rentalBooking)
        {
            await _rentalBookingRepository.DeleteAsync(rentalBooking);
        }
        public virtual async Task InsertRentalBookingAsync(RentalBooking rentalBooking)
        {
            await _rentalBookingRepository.InsertAsync(rentalBooking);
        }
        public virtual async Task UpdateRentalBookingAsync(RentalBooking rentalBooking)
        {
            await _rentalBookingRepository.UpdateAsync(rentalBooking);
        }
