...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        #region Rental Booking
         Task<RentalBooking> GetRentalBookingByIdAsync(int rentalBookingId);
        Task<IPagedList<RentalBooking>> GetAllRentalBookingAsync(string name = null, int typeId = (int)BookingEnum.RentalBooking, int pageIndex = 0, int pageSize = int.MaxValue);
         Task DeleteRentalBookingAsync(RentalBooking rentalBooking);
         Task InsertRentalBookingAsync(RentalBooking rentalBooking);
         Task UpdateRentalBookingAsync(RentalBooking rentalBooking);
